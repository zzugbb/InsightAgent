...
- 本轮启动的 8011 低并发 backend 已发送 Ctrl+C 并正常退出，`lsof -nP -iTCP:8011 -sTCP:LISTEN` 无输出；8000/3001 沿用最近 full e2e 轮次的正常退出记录。
- `git diff --check`：通过
