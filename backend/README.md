...
- `real-tool-execution` 当前验收基线已收尾完成：provider/source 中已经能注册和规划的 real tools 已推进到真实请求模板、真实上游响应映射、result preview/output、runtime semantic、trace/observation/export 与后端/Chromium e2e 回归的一体化执行链。
