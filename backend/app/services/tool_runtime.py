...
def build_configured_tool_registry_provider_preflight_service_execution_result_model_from_dict(
    *,
    ...
    _, execution_result_model = build_configured_tool_registry_provider_preflight_execution_models_from_dict(
        preflight_result=preflight_result,
    )
...
def build_configured_tool_registry_provider_preflight_models_from_service_execution_payload(
    *,
    ...
    return build_configured_tool_registry_provider_preflight_models(
        service_execution=service_execution,
...
def build_configured_tool_registry_provider_preflight_outputs_from_models(
    *,
    ...
    return (
        ...
        summary_model,
        result_model,
        summary_model.to_dict(),
        result_model.to_dict(),
    )
...
def build_configured_tool_registry_provider_preflight_result_model(
    *,
    ...
    _, _, _, result_model = build_configured_tool_registry_provider_preflight_models(
        service_execution=service_execution,
        execution_result=execution_result,
    )
    return result_model
