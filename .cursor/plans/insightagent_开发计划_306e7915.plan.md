...
- planner / provider planner：支持 real/extra tools、动态 registry/source 候选、Chat Completions / Responses 风格工具调用输出、顶层 message/delta wrapper、camelCase toolCalls/toolName/functionName、typed SDK-style payload 与 usage alias。
