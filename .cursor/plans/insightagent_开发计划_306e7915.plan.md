...
validation_baseline:
  backend_slice: backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py (1983/1983)
  ...
  backend_provider_tool_singular_tool_call_slice: backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py -k singular_tool_call_container (1/1)
  backend_provider_tool_nested_tool_object_slice: backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py -k nested_tool_object (1/1)
  backend_provider_tool_function_calls_slice: backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py -k function_calls_container (1/1)
  backend_tool_plan_provider_slice: backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py -k tool_plan_provider (57/57)
...
- planner / provider planner：支持 real/extra tools、动态 registry/source 候选、Chat Completions / Responses 风格工具调用输出、Gemini/Vertex functionCall/function_calls、Bedrock/Claude Converse toolUse、Anthropic Messages mixed text/tool_use content、顶层 message/delta wrapper、tool_call 单数容器、tool_calls/toolCalls 映射容器、camelCase toolCalls/toolInvocations/toolName/functionName、嵌套 tool 对象、typed SDK-style payload 与 usage alias。
...
- Backend slice：`backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py`，当前 `1983/1983`。
...
- Backend tool plan provider slice：`backend/.venv/bin/python backend/scripts/test_tool_runtime_slice.py -k tool_plan_provider`，当前 `57/57`。
