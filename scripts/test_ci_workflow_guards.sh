...
main() {
  ...
  assert_contains "Write release gate trend summary" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "bash scripts/ci_release_gate_trend_summary.sh \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--current-json /tmp/release-gate-summary.json \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--summary-file /tmp/release-gate-trend-summary.md \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--json-summary-file /tmp/release-gate-trend-summary.json" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "name: release-gate-trend-summary" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "/tmp/release-gate-trend-summary.md" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "/tmp/release-gate-trend-summary.json" "${RELEASE_GATE_WORKFLOW}"
