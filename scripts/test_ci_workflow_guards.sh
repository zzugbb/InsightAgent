...
main() {
  ...
  assert_contains "RELEASE_GATE_SOURCE_BRANCH: \${{ github.head_ref || github.ref_name }}" "${RELEASE_GATE_WORKFLOW}"
  ...
  assert_contains "permissions:" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "contents: read" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "actions: read" "${RELEASE_GATE_WORKFLOW}"
  ...
  assert_contains "--summary-file /tmp/release-gate-summary.md \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--json-summary-file /tmp/release-gate-summary.json" "${RELEASE_GATE_WORKFLOW}"
  assert_contains 'cat /tmp/release-gate-summary.md >> "$GITHUB_STEP_SUMMARY"' "${RELEASE_GATE_WORKFLOW}"
  assert_contains "name: release-gate-summary" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "            /tmp/release-gate-summary.md" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "            /tmp/release-gate-summary.json" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "Download previous release gate summary" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "GH_TOKEN: \${{ github.token }}" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "bash scripts/ci_download_previous_release_gate_summary.sh \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--workflow release-gate.yml \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains '--branch "${RELEASE_GATE_SOURCE_BRANCH}" \' "${RELEASE_GATE_WORKFLOW}"
  assert_contains '--current-run-id "${GITHUB_RUN_ID}" \' "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--output-file /tmp/previous-release-gate-summary.json \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--summary-file /tmp/previous-release-gate-download-summary.md \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--json-summary-file /tmp/previous-release-gate-download-summary.json" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "Write release gate trend summary" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "previous_summary_args=()" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "[ -f /tmp/previous-release-gate-summary.json ]" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "previous_summary_args=(--previous-json /tmp/previous-release-gate-summary.json)" "${RELEASE_GATE_WORKFLOW}"
  ...
  assert_contains "Validate operator summaries" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "bash scripts/ci_assert_operator_summary_contract.sh \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--summary-json /tmp/release-gate-summary.json \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--summary-kind release_gate \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--markdown /tmp/release-gate-summary.md" "${RELEASE_GATE_WORKFLOW}"
  assert_not_contains '--markdown "$GITHUB_STEP_SUMMARY"' "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--summary-json /tmp/release-gate-trend-summary.json \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--summary-kind release_gate_trend \\" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "--markdown /tmp/release-gate-trend-summary.md" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "name: release-gate-trend-summary" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "/tmp/previous-release-gate-summary.json" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "/tmp/previous-release-gate-download-summary.md" "${RELEASE_GATE_WORKFLOW}"
  assert_contains "/tmp/previous-release-gate-download-summary.json" "${RELEASE_GATE_WORKFLOW}"
