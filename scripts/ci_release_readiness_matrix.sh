...
| release-visibility-summary | yes | no | `bash scripts/ci_run_release_gate.sh --phase all --summary-file <path> --json-summary-file <path>` | Captures resolved phases, step results, and `decision_summary` for release approval and post-release comparison. |
  ...
  cat <<'JSON'
{
  ...
  "gates": [
    ...
    },
    {
      ...
      "notes": "Captures resolved phases, step results, and decision_summary for release approval and post-release comparison."
    },
    {
