...
main() {
  ...
  assert_contains "npm run build:webpack" "${TMP_DIR}/all.txt"
  ...
  assert_contains '"label": "frontend webpack build"' "${TMP_DIR}/summary.json"
...
SH
  ...
  assert_contains "npm run build:webpack" "${TMP_DIR}/frontend.txt"
