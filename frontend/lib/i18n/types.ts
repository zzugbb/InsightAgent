...
export type Messages = {
  ...
  sidebar: {
    ...
    audit: {
      ...
      filterEventSettingsValidate: string;
      filterEventTaskCreate: string;
      filterEventTaskCancel: string;
      filterEventTaskTimeout: string;
      filterEventTaskFailed: string;
      filterEventRagIngest: string;
      filterEventRagKbClear: string;
      filterEventRagKbDelete: string;
      ...
      eventLabelSettingsValidate: string;
      eventLabelTaskCreate: string;
      eventLabelTaskCancel: string;
      eventLabelTaskTimeout: string;
      eventLabelTaskFailed: string;
      eventLabelRagIngest: string;
      eventLabelRagKbClear: string;
      eventLabelRagKbDelete: string;
      ...
      fieldDocumentCount: string;
      fieldChunkSize: string;
      fieldChunkOverlap: string;
  ...
  inspector: {
    ...
    rag: {
      ...
      combinedFilterEmpty: string;
      filterEmptyGeneric: string;
  ...
  taskDetail: {
    ...
    lastObservationTitle: string;
    exportJson: string;
    exportMarkdown: string;
    exportJsonDone: string;
