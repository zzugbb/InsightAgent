...
export const zh: Messages = {
  ...
  auth: {
    ...
    settingsTitle: "登录页设置",
    onboardingTitle: "完成首次模型配置",
    onboardingLead:
      "继续进入工作台前，请先设置 provider、model 与 API Key。保存后系统会切换到 remote 模式。",
    onboardingProviderLabel: "Provider",
    onboardingProviderPlaceholder: "例如 openai / anthropic",
    onboardingModelLabel: "Model",
    onboardingModelPlaceholder: "例如 gpt-4o-mini",
    onboardingBaseUrlLabel: "Base URL（可选）",
    onboardingBaseUrlPlaceholder: "例如 https://api.openai.com/v1",
    onboardingApiKeyLabel: "API Key",
    onboardingApiKeyPlaceholder: "输入可用密钥后保存",
    onboardingSave: "保存并进入工作台",
    onboardingSaving: "保存中…",
    onboardingSaved: "配置已保存，正在进入工作台",
    onboardingLogout: "切换账号",
  },
  workbench: {
  ...
  sidebar: {
    ...
    audit: {
      title: "审计日志",
      lead: "按事件类型、时间范围和会话/任务 ID 过滤，支持导出 JSON 或 CSV。",
