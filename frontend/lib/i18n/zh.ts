...
export const zh: Messages = {
  ...
  taskCenter: {
    ...
    observabilityFilterAll: "全部观测",
    observabilityFilterAttention: "需要关注",
    ...
    operatorHintFailureHint: "查看 Failure 轨迹并修复失败来源",
    operatorHintFailureTrace: "重试前先复核 Failure 轨迹",
    operatorHintQueued: "再次发送前先观察队列容量",
    operatorHintRunning: "等待任务结束并关注实时流",
    openTaskDetail: "任务详情",
  ...
  sidebar: {
    ...
    audit: {
      ...
      filterEventSettingsValidate: "设置校验",
      filterEventTaskCreate: "任务创建",
      filterEventTaskCancel: "任务取消",
      filterEventTaskTimeout: "任务超时",
      filterEventTaskFailed: "任务失败",
      filterEventRagIngest: "知识库写入",
      filterEventRagKbClear: "知识库清空",
      filterEventRagKbDelete: "知识库删除",
      ...
      detailLabel: "详情",
      detailExpand: "展开详情",
      operatorHintTitle: "下一步处置",
      operatorHintTaskFailure: "先打开 Failure 回放，再决定是否重试。",
      operatorHintTaskTimeout: "先打开超时回放，再决定下一步处置。",
      operatorHintOpenFailureTrace: "打开 Failure 回放",
      eventLabelLogin: "登录",
      eventLabelLogout: "登出",
      eventLabelRefresh: "刷新令牌",
      eventLabelSettingsUpdate: "设置更新",
      eventLabelSettingsValidate: "设置校验",
      eventLabelTaskCreate: "任务创建",
      eventLabelTaskCancel: "任务取消",
      eventLabelTaskTimeout: "任务超时",
      eventLabelTaskFailed: "任务失败",
      eventLabelRagIngest: "知识库写入",
      eventLabelRagKbClear: "知识库清空",
      eventLabelRagKbDelete: "知识库删除",
      ...
      fieldDocumentCount: "当前文档数",
      fieldChunkSize: "分块大小",
      fieldChunkOverlap: "分块重叠",
      sessionLinked: "关联会话",
  ...
  inspector: {
    ...
    usageTotal: "总 tokens",
    usageCost: "预估费用",
    usagePlanningTitle: "规划阶段",
    usageOverallTitle: "整体总计",
    usageSource: "来源",
    ...
    sessionGovernanceTitle: "会话工具治理",
    sessionGovernanceLead: "汇总当前会话实际运行过的 tool registry 治理边界。",
    ...
    rag: {
      ...
      ingestFailedTitle: "写入失败",
      queryPlaceholder: "输入检索问题或关键词…",
      queryButton: "检索知识库",
      queryEmptyInput: "请先输入检索内容。",
      queryFailedTitle: "检索失败",
      recoveryRetry: "重试",
      recoveryRetryHint: "输入内容已保留，可在服务恢复后直接重试。",
      recoveryReviewInputHint: "请检查知识库 ID 与输入内容后重新提交。",
      recoveryReauthenticateHint: "请重新登录，或联系管理员确认访问权限。",
      ...
      recallGuidanceStrong: "召回匹配度较好。",
      recallGuidanceMedium: "使用前建议先核对命中文本。",
      recallGuidanceWeak: "可尝试更具体的问题或补充更匹配的资料。",
      qualityFilterLabel: "召回质量",
      qualityFilterAll: "全部",
      qualityFilterShowing: (visible, total) => `显示 ${visible}/${total}`,
      qualityFilterEmpty: "没有匹配该召回质量的命中。",
      sourceFilterEmpty: "没有匹配该来源的命中。",
      combinedFilterEmpty: "没有同时匹配该召回质量和来源的命中。",
      filterEmptyGeneric: "没有匹配当前筛选条件的命中。",
  ...
  taskDetail: {
    ...
    usageLead: "用量统计",
    operatorHintTitle: "下一步处置",
    operatorHintFailureHint: "先复核失败线索与来源，再决定是否重试。",
    operatorHintFailureTrace: "先复核 Failure 轨迹，再决定是否重试。",
    operatorHintQueued: "等待任务获得执行槽位。",
    operatorHintRunning: "持续观察实时流，直到任务结束。",
    ...
    traceSemanticFilterCalculator: "Calculator",
    traceSemanticFilterFailure: "Failure",
    traceSearchPlaceholder: "按步骤标题、内容或模型检索",
    traceDensityComfortable: "标准",
    traceDensityCompact: "紧凑",
    traceVisibleCount: (shown: number, total: number) => `显示 ${shown} / ${total}`,
    traceEmpty: "当前任务暂无轨迹数据。",
    traceNoMatch: "没有匹配当前筛选条件的步骤。",
    traceMetaNone: "暂无步骤元信息",
    loading: "正在加载任务详情…",
    loadFailed: "任务详情加载失败。",
    notFound: "任务不存在或无权限访问。",
    governanceTitle: "工具治理摘要",
    ...
    semanticFailureLabel: "Failure 轨迹",
    taskPromptTitle: "任务输入",
    finalAnswerTitle: "最终回答（摘要）",
    finalAnswerEmpty: "未在轨迹中解析到最终回答。",
    lastObservationTitle: "最终观察",
    exportJson: "导出 JSON",
    exportMarkdown: "导出 Markdown",
    exportJsonDone: "任务 JSON 已导出。",
    exportMarkdownDone: "任务 Markdown 已导出。",
  },
  settings: {
    title: "运行设置",
