...
export const en: Messages = {
  ...
  auth: {
    ...
    onboardingTitle: "Complete first-time model setup",
    onboardingLead:
      "Before entering the workbench, configure provider, model, and API key. Saving switches runtime to remote mode.",
    onboardingProviderLabel: "Provider",
    onboardingProviderPlaceholder: "e.g. openai / anthropic",
    onboardingModelLabel: "Model",
    onboardingModelPlaceholder: "e.g. gpt-4o-mini",
    onboardingBaseUrlLabel: "Base URL (optional)",
    onboardingBaseUrlPlaceholder: "e.g. https://api.openai.com/v1",
    onboardingApiKeyLabel: "API Key",
    onboardingApiKeyPlaceholder: "Paste a valid key and save",
    onboardingSave: "Save and open workbench",
    onboardingSaving: "Saving…",
    onboardingSaved: "Setup saved. Entering workbench...",
    onboardingLogout: "Switch account",
  },
  workbench: {
  ...
  sidebar: {
    ...
    audit: {
      title: "Audit logs",
      lead:
        "Filter by event type, time range, and optional session/task IDs. Export as JSON or CSV.",
