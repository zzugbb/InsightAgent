...
export const en: Messages = {
  ...
  taskCenter: {
    ...
    observabilityFilterAll: "All observability",
    observabilityFilterAttention: "Needs attention",
    ...
    semanticPlannerLabel: "Planner",
    semanticRetrievalLabel: "Retrieval",
    semanticCalculatorLabel: "Calculator",
    semanticFailureLabel: "Failure",
    operatorHintFailureHint: "Open Failure trace and fix the reported source",
    operatorHintFailureTrace: "Review Failure trace before retrying",
    operatorHintQueued: "Watch queue capacity before sending another run",
    operatorHintRunning: "Monitor live stream until the task finishes",
  ...
  sidebar: {
    ...
    audit: {
      ...
      filterEventSettingsValidate: "Settings validate",
      filterEventTaskCreate: "Task create",
      filterEventTaskCancel: "Task cancel",
      filterEventTaskTimeout: "Task timeout",
      filterEventTaskFailed: "Task failed",
      filterEventRagIngest: "RAG ingest",
      filterEventRagKbClear: "KB clear",
      filterEventRagKbDelete: "KB delete",
      ...
      operatorHintTaskFailure: "Open the failure replay before deciding whether to retry.",
      operatorHintTaskTimeout: "Open the timeout replay before deciding the next step.",
      operatorHintOpenFailureTrace: "Open Failure replay",
      eventLabelLogin: "Login",
      eventLabelLogout: "Logout",
      eventLabelRefresh: "Token refresh",
      eventLabelSettingsUpdate: "Settings update",
      eventLabelSettingsValidate: "Settings validate",
      eventLabelTaskCreate: "Task create",
      eventLabelTaskCancel: "Task cancel",
      eventLabelTaskTimeout: "Task timeout",
      eventLabelTaskFailed: "Task failed",
      eventLabelRagIngest: "RAG ingest",
      eventLabelRagKbClear: "KB clear",
      eventLabelRagKbDelete: "KB delete",
      ...
      fieldDocumentCount: "Document count",
  ...
  inspector: {
    ...
    traceSemanticFilterFailure: "Failure",
    ...
    usagePlanningTitle: "Planning",
    usageOverallTitle: "Overall",
    usageSource: "Source",
    ...
    sessionGovernanceLead:
      "Summarize which tool registry rules were actually used across tasks in this session.",
    sessionGovernanceProfiles: "Profiles",
    sessionGovernanceSources: "Provider sources",
    sessionGovernanceAllowedTools: "Allowed tools",
    sessionGovernanceNone: "—",
    ...
    rag: {
      ...
      recallGuidanceStrong: "Good retrieval fit.",
      recallGuidanceMedium: "Review the retrieved text before using it.",
      recallGuidanceWeak: "Try a more specific query or add better source text.",
      qualityFilterLabel: "Recall quality",
      qualityFilterAll: "All",
      qualityFilterShowing: (visible, total) => `Showing ${visible}/${total}`,
      qualityFilterEmpty: "No hits match this recall quality.",
      sourceFilterEmpty: "No hits match this source.",
      combinedFilterEmpty: "No hits match this recall quality and source.",
      filterEmptyGeneric: "No hits match the current filters.",
  ...
  taskDetail: {
    ...
    heading: "Task Detail",
    lead:
      "Review snapshot, replay trace, and export artifacts for debugging and delivery handoff.",
    taskIdLabel: "Task ID",
    sessionIdLabel: "Session ID",
    statusLabel: "Status",
    createdAtLabel: "Created at",
    updatedAtLabel: "Updated at",
    stepCountLabel: "Trace steps",
    ragHitsLabel: "RAG hits",
    ragKnowledgeBasesLabel: (ids: string) => `Knowledge bases hit: ${ids}`,
    usageLead: "Usage",
    operatorHintTitle: "Next action",
    operatorHintFailureHint: "Review the failure hint and source before retrying.",
    operatorHintFailureTrace: "Review the failure trace before retrying.",
    operatorHintQueued: "Waiting for an execution slot.",
    operatorHintRunning: "Monitor the live stream until the task finishes.",
    failureHintTitle: "Failure hint",
    viewFailureTrace: "View failure traces",
    ...
    traceSemanticFilterCalculator: "Calculator",
    traceSemanticFilterFailure: "Failure",
    traceSearchPlaceholder: "Search by step title, content, or model",
    traceDensityComfortable: "Comfortable",
    traceDensityCompact: "Compact",
    traceVisibleCount: (shown: number, total: number) =>
      `Showing ${shown} of ${total}`,
    traceEmpty: "No trace data for this task yet.",
    traceNoMatch: "No steps match the current filters.",
    traceMetaNone: "No step metadata",
    loading: "Loading task detail…",
    loadFailed: "Failed to load task detail.",
    notFound: "Task was not found or is not accessible.",
    governanceTitle: "Tool governance",
    governanceProfileLabel: "Profile",
    ...
    semanticFailureLabel: "Failure traces",
    ...
    lastObservationTitle: "Last observation",
    exportJson: "Export JSON",
    exportMarkdown: "Export Markdown",
    exportJsonDone: "Task JSON exported.",
