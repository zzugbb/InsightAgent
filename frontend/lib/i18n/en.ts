...
export const en: Messages = {
  ...
  workbench: {
    ...
    loadedSessions: "Recent sessions loaded.",
    noTasks: "No tasks yet.",
    loadedTasks: "Recent tasks loaded.",
    ...
    composerIdleHint:
      "Enter to send, Shift+Enter for a new line. ⌘K / Ctrl+K focuses the input.",
  ...
  chat: {
    ...
    autoCreateHint: "Sending without a session will create one automatically.",
  ...
  sidebar: {
    ...
    brandLead: "Chat in the center; execution unfolds in the trace panel.",
